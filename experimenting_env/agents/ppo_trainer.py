...
@baseline_registry.register_trainer(name="myppo")
class PPOTrainer(BaseRLTrainer):
    ...
    _obs_batching_cache: _ObservationBatchingCache
    envs: VectorEnv
    agent: PPO
    actor_critic: Policy
    ...
    def _init_envs(self, config=None, kwargs=None):
        ...
        self.envs = construct_envs(
            config, get_env_class(config.ENV_NAME), is_slurm_batch_job(), **kwargs
        )
